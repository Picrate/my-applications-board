...
INSERT INTO CONTACTS(FIRSTNAME, LASTNAME, EMAIL, ADDRESS_ID, ROLE_ID, TITLE_ID) VALUES
    ('Nanine', 'Pea', 'npea0@ifeng.com', 1,1,2 ),
    ('Sandie', 'Thorbon', 'sthorbon1@wufoo.com', 2,2,2),
    ('Aleta', 'Bradbeer', 'abradbeer2@springer.com', 3,3,1)
;
